...
namespace EventB.Migrations
{
    ...
    [Migration("20200329172117__2903_addFields")]
    partial class _2903_addFields
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventB.Models.Friend", b =>
                {
            ...
            modelBuilder.Entity("EventB.Models.Interes", b =>
                {
            ...
            modelBuilder.Entity("EventB.Models.User", b =>
                {
            ...
            modelBuilder.Entity("EventB.Models.Vizit", b =>
                {
            ...
            modelBuilder.Entity("EventB.Models.Event", b =>
                {
                    ...
                    b.HasOne("EventB.Models.User", "Creator")
                        .WithMany("MyEvents")
            ...
            modelBuilder.Entity("EventB.Models.Friend", b =>
                {
                    b.HasOne("EventB.Models.User", null)
                        .WithMany("Friends")
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("EventB.Models.Interes", b =>
                {
                    b.HasOne("EventB.Models.User", "User")
                        .WithMany("Intereses")
                        .HasForeignKey("UserId");
                });
